export const introContent = {
  0: '//// Hi, and welcome to the onboarding questionnaire! Press the space bar to continue.',
  1: '//// We’re so glad you’ve decided to take part in our project, but first, let me explain a little about the project.',
  2: '//// During this intro, you just press the space bar to advance. During the questionnaire, fill out the required information and press enter or click the yellow ’submit’ function at the end of the form.',
