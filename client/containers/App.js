...
import NoMobile from "../components/static/noMobile";
				...
				<Router history={browserHistory}>
					<div
						...
						<main className="content">
							...
							<Route exact path="/home" render={() => <Redirect to="/me" />} />
							...
							<Route path="/team/:teamId" component={TeamScreen} />
						</main>
						<Footer />
					</div>
				</Router>
